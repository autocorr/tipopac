...
from .private.task_tipopac import tipopac as _tipopac_t
...
class _tipopac:
    ...
    * flagFile -- Text file containing manual flags.  Special syntax is required.
    ...
    def __call__( self, msname='', caltableZ='', tauPerAnt=False, calcTcals=True, caltableT='', cmdFlag=True, usrFlag=False, flagFile='', caltable=False, doPlot=False, doModel=False ):
        schema = {'msname': {'type': 'cReqPath', 'coerce': _coerce.expand_path}, 'caltableZ': {'type': 'cStr', 'coerce': _coerce.to_str}, 'tauPerAnt': {'type': 'cBool'}, 'calcTcals': {'type': 'cBool'}, 'caltableT': {'type': 'cStr', 'coerce': _coerce.to_str}, 'cmdFlag': {'type': 'cBool'}, 'usrFlag': {'type': 'cBool'}, 'flagFile': {'type': 'cStr', 'coerce': _coerce.to_str}, 'caltable': {'type': 'cBool'}, 'doPlot': {'type': 'cBool'}, 'doModel': {'type': 'cBool'}}
        doc = {'msname': msname, 'caltableZ': caltableZ, 'tauPerAnt': tauPerAnt, 'calcTcals': calcTcals, 'caltableT': caltableT, 'cmdFlag': cmdFlag, 'usrFlag': usrFlag, 'flagFile': flagFile, 'caltable': caltable, 'doPlot': doPlot, 'doModel': doModel}
        assert _pc.validate(doc,schema), create_error_string(_pc.errors)
        _logging_state_ = _start_log( 'tipopac', [ 'msname=' + repr(_pc.document['msname']), 'caltableZ=' + repr(_pc.document['caltableZ']), 'tauPerAnt=' + repr(_pc.document['tauPerAnt']), 'calcTcals=' + repr(_pc.document['calcTcals']), 'caltableT=' + repr(_pc.document['caltableT']), 'cmdFlag=' + repr(_pc.document['cmdFlag']), 'usrFlag=' + repr(_pc.document['usrFlag']), 'flagFile=' + repr(_pc.document['flagFile']), 'caltable=' + repr(_pc.document['caltable']), 'doPlot=' + repr(_pc.document['doPlot']), 'doModel=' + repr(_pc.document['doModel']) ] )
        task_result = None
        try:
            task_result = _tipopac_t( _pc.document['msname'], _pc.document['caltableZ'], _pc.document['tauPerAnt'], _pc.document['calcTcals'], _pc.document['caltableT'], _pc.document['cmdFlag'], _pc.document['usrFlag'], _pc.document['flagFile'], _pc.document['caltable'], _pc.document['doPlot'], _pc.document['doModel'] )
        except Exception as exc:
            _except_log('tipopac', exc)
            raise
        finally:
            task_result = _end_log( _logging_state_, 'tipopac', task_result )
        return task_result
